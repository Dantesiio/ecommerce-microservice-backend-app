  ...
  spec {
    ...
    template {
      ...
      spec {
        container {
          name  = "eureka-service"
          image = "dantesiio/service-discovery-ecommerce-boot:0.1.0"
  ...
  spec {
    ...
    template {
      ...
      spec {
        container {
          name  = "cloud-config-service"
          image = "dantesiio/cloud-config-ecommerce-boot:0.1.0"
  ...
  spec {
    ...
    template {
      ...
      spec {
        container {
          name  = each.value
          image = "dantesiio/${each.value}-ecommerce-boot:0.1.0"
